...
export declare const collapseSingleNode: (path: string) => (state: JsonViewerState) => Partial<JsonViewerState>;
export declare const expandSingleNode: (path: string) => (state: JsonViewerState) => Partial<JsonViewerState>;
